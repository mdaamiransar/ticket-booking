...
<section id="content">
	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body card-padding">
				...
				<c:url var="addAction" value="${contextRoot}/cp/seatType/add"></c:url>
				<form:form class="form-horizontal" modelAttribute="seatType" 
					action="${addAction}" 
					method="POST">
	...
	<div class="container">
		...
		<div class="card">
			<div class="card-header">
				<h2>
					${title} <small>Seat Type Management </small>
				</h2>
			</div>

			<div class="table-responsive">
				<table id="seatTypeListTable" class="table table-striped">
					<thead>
						<tr>
							<th>Code</th>
							<th>Name</th>
