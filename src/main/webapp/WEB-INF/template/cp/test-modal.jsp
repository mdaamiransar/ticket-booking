		...
		<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-md-8">
						<h2>
							${title} <small>Here you can see all About, which
								is created by you.</small>
						</h2>
					</div><!-- href="#modalDefault" -->
					<div class="col-md-4 text-right">
						<button class="btn bgm-amber" data-toggle="modal" data-target="#myCategoryModal">
			...
			<div class="card-body card-padding">
				...
				<c:url var="addAction" value="${contextRoot}/cp/category/add"></c:url>
				<form:form class="form-horizontal" modelAttribute="category" action="${addAction}" method="POST">
	  ...
	  <div class="modal-dialog" role="document" style="width: 60%;">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel">New Category</h4><hr>
	      </div>
	      <div class="modal-body">
	        
	        <div class="row">
				
			<c:url var="addAction" value="${contextRoot}/cp/test/add"></c:url>
			<form:form class="form-horizontal" modelAttribute="category" action="${addAction}" method="POST">
