...
<section id="content">
	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body card-padding">
				...
				<c:url var="addAction" value="${contextRoot}/cp/amenities/add"></c:url>
				<form:form class="form-horizontal" modelAttribute="amenities" 
					action="${addAction}" 
					method="POST"
	...
	<div class="container">
		...
		<div class="card">
			<div class="card-header">
				<h2>
					${title} <small>Amenities Management. </small>
				</h2>
			</div>

			<div class="table-responsive">
				<table id="amenitiesListTable" class="table table-striped">
					<thead>
						<tr>
							<th>ID</th>
							<th>Amenities</th>
