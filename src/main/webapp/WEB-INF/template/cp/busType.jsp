...
<section id="content">
		...
		<div class="card">
			...
			<div class="card-body card-padding">
				...
				<div class="row">
					...
					<c:url var="addAction" value="${contextRoot}/cp/busType/add"></c:url>
					<form:form class="form-horizontal" modelAttribute="busType"
	...
	<div class="container">
		...
		<div class="card">
			<div class="card-header">
				<h2>
					${title} <small>Bus Type Management </small>
				</h2>
			</div>

			<div class="table-responsive">
				<table id="busTypeListTable" class="table table-striped">
					<thead>
						<tr>
							<th>Code</th>
							<th>Name</th>
