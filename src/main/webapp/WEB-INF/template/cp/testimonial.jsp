	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body card-padding">
				...
				<c:url var="addAction" value="${contextRoot}/cp/testimonial/add"></c:url>
				<form:form class="form-horizontal" modelAttribute="testimonial" 
					action="${addAction}" 
					method="POST"
	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="table-responsive">
				<table id="testimonialListTable" class="table table-striped">
					<thead>
						<tr>
							<th>ID</th>
							<th>Name</th>
