	...
	<div class="topnav hidden-xs">
	    <div class="container">
	        ...
	        <ul class="quick-menu pull-right">
	            <!-- <li>
	            <a href="http://themeforest.net/item/travelo-responsive-travel-booking-site-template/8346649?ref=SoapTheme" class="button yellow btn-small" style="height: 30px; font-size: 1em;"><i class="soap-icon-shopping"></i> PURCHASE</a>
	            </li> -->
	        ...
	        <div class="container">
	            ...
	            <nav id="main-menu" role="navigation">
	                <ul class="menu">
	                    ...
	                    <li class="menu-item-has-children">
	                        <a href="hotel-index.html">Bus Booking</a>
	                        <ul>
	                    ...
	                    <li class="menu-item-has-children">
	                        <a href="flight-index.html">Bus Hire</a>
	                    </li>
	                    <li class="menu-item-has-children">
	                        <a href="car-index.html">About Us</a>	                      
	                    </li>
	                    <li class="menu-item-has-children">
	                        <a href="cruise-index.html">Contact Us</a>	                        
	                    </li>
	    ...
	    <div id="travelo-login" class="travelo-login-box travelo-box">
	        ...
	        <form action="${contextRoot}/login" method="POST">
	            <div class="form-group">
	                <input name="username" id="username" type="text" class="input-text full-width" placeholder="email address">
	            </div>
	            <div class="form-group">
	                <input name="password" id="password" type="password" class="input-text full-width" placeholder="password">
	            </div>
	            <div class="form-group">
