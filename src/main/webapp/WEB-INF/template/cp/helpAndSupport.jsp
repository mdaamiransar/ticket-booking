	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body card-padding">
				...
				<c:url var="addAction" value="${contextRoot}/cp/helpAndSupport/add"></c:url>
				<form:form class="form-horizontal" modelAttribute="helpAndSupport" 
					action="${addAction}" 
					method="POST"
	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="table-responsive">
				<table id="helpAndSupportListTable" class="table table-striped">
					<thead>
						<tr>
							<th>ID</th>
							<th>Name</th>
